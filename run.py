...
directly at colmap_preprocessor/app.py, the relative imports inside main()
(``from .onnx_utils import ...``) fail with:
    ImportError: attempted relative import with no known parent package

This launcher runs as a top-level module (no relative imports here), then
imports colmap_preprocessor.app — which establishes the package context so
all relative imports inside the package resolve correctly.
"""

from colmap_preprocessor.app import main
